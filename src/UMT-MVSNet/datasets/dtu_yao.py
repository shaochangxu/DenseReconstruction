...
class MVSDataset(Dataset):
    def __init__(self, datapath, listfile, mode, nviews, ndepths=192, interval_scale=1.06, inverse_depth=False,
        ...
        self.both = both # reverse and not reverse
    ...
    def build_list(self):
        ...
        for scan in scans:
            '''
                pair file structure:
                num_viewpoint in first line
                ref_view_id0
                src_views_num src_view0_id src_view0_score src_view1_id src_view1_score ...
                ref_view_id1
                src_views_num src_view0_id src_view0_score src_view1_id src_view1_score ...
                ...
            '''
