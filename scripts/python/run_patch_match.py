...
os.system(build_path + "patch_match_stereo --workspace_path " + dense_dir + " --workspace_format COLMAP --PatchMatchStereo.geom_consistency false --PatchMatchStereo.algo ACMM")
